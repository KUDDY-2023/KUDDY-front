          ...
          {cookies.get('chatRoomid') ? (
            ...
            <div className="chat__detail" style={{ 'align-items': 'center' }}>
              {!cookies.get('chatRoomid') && isLoading === false ? (
                <>
                  <img
                    className="chat__main__img"
                    src="images/chat_main_image.jpg"
                    alt="채팅방 메인 이미지"
                  />
                  <button
                    className="chat__match__btn"
                ...
                <>
                  <img
                    className="chat__loading__img"
                    src="images/loading.gif"
                    alt="채팅방 로딩 이미지"
                  />
                  <span className="chat__loading__text">
                    대기 중인 유저를 찾고 있습니다.
                  </span>
                </>
              )}
